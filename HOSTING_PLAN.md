...
- many future architecture paths if Collecttrade grows into a larger subscription product
...
- if Collecttrade needs a more enterprise-grade production stack later, AWS is a strong option
