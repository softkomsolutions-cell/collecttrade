...
function sanitizeCollectibleHolding(input) {
  ...
  return {
    ...
    quantity,
    purchasePriceZAR,
    purchaseDate: cleanCollectibleText(input?.purchaseDate, 40),
    currentValueZAR,
    ...
    riskRating: cleanCollectibleText(input?.riskRating, 80),
    certificationNotes: cleanCollectibleText(input?.certificationNotes, 700),
  ...
  try {
    ...
    const holding = sanitizeCollectibleHolding({
      ...
      inputSnapshot: {
        ...
        certificationNotes: req.body?.certificationNotes,
      },
    });
