...
export const PAGE_SECTION_LINKS = {
  ...
  collectibles: [
    { id: "collectibles-valuation", label: "Investment Analysis" },
    { id: "collectibles-portfolio", label: "Dashboard" },
    { id: "collectibles-owned-inventory", label: "Holdings" },
    { id: "collectibles-reviewed-portfolios", label: "AI Watchlist" },
    { id: "collectibles-reports", label: "Reports" },
  ],
  portfolio: [
...
export const INTRO_ACTIONS = [
  {
    ...
    blurb: "Score a collectible purchase and review the 1, 5, and 10 year value scenarios.",
  },
  {
    id: "inventory",
    ordinal: "02",
